...
namespace Class_Grid
{
	...
	class Grid
	{
		...
		public List<List<int>> Place_ship(List<List<int>> Used_coords, List<List<int>> Occupied_coords) 
		{
		...
		public List<List<int>> Add_hit(List<int> Used_coords, List<List<int>> Hit_coords)
		{
		...
		public List<List<int>> Add_miss(List<int> Used_coords, List<List<int>> Miss_coords)
        {
		...
		public (bool, List<List<int>>) Check_coords(List<List<int>> Possible_coords, List<List<int>> Occupied_coords) //returns true if coordinates are occupied, false if they are not.
		{
